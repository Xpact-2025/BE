...
import com.itstime.xpact.global.security.service.OAuth2Service;
...
//        LoginResponseDto responseDto = oAuth2Service.login(requestDto);
//        return ResponseEntity.ok(
//                RestResponse.ok(responseDto)
//        );
//    }
//
//    @GetMapping("/login/kakao")
//    public ResponseEntity<RestResponse<?>> loginByKakao(
//            @RequestParam(name = "code") String code
//    ) throws CustomException {
//        return ResponseEntity.ok(
//                oAuth2Service.loginWithCode(code);
//        );
//    }
    ...
    public ResponseEntity<RestResponse<?>> formLogin(
        ...
        return ResponseEntity.ok(
                RestResponse.ok(
                        oAuth2Service.formLogin(requestDto, response)
                ));
    }
    ...
    public ResponseEntity<RestResponse<SignupResponseDto>> signup (
        ...
        return ResponseEntity.ok(
                RestResponse.ok(
                        oAuth2Service.register(signupRequestDto))
        );
    }
    ...
    public ResponseEntity<RestResponse<?>> logout(
        ...
        oAuth2Service.logout(response, token);
    ...
    public ResponseEntity<RestResponse<?>> refresh(
        ...
        return ResponseEntity.ok(
                RestResponse.ok(
                        oAuth2Service.refresh(request, response)));
    }
}
